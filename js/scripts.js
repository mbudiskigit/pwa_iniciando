...
let updateList = function(){
    ...
    Array.observe(notes.data, function(changes){
        ...
        let notesTag = document.getElementById('li-notes');
        ...
        if(status === 'removed'){
            let listOfNotes = document.querySelectorAll('#li-notes li');
        ...
        if(status === 'created'){
            ...
            let input = document.querySelector('#form-add-note input[type="text"]').focus();
        }
...
document.addEventListener('DOMContentLoaded', function(event){
    ...
    let listOfNotes = document.getElementById('li-notes');
    let listHtml = '';
